 ...
 */
class AccountOptions extends \Amulet\Entity\AccountOptions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Amulet\\Entity\\AccountOptions' . "\0" . 'id', '' . "\0" . 'Amulet\\Entity\\AccountOptions' . "\0" . 'name', '' . "\0" . 'Amulet\\Entity\\AccountOptions' . "\0" . 'role', '' . "\0" . 'Amulet\\Entity\\AccountOptions' . "\0" . 'account');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccountOptions $proxy) {
